...
load_plugin_textdomain('codecocktail-wikiprofile', false, basename( dirname( __FILE__ ) ) . '/languages' );
}
...
function wikiprofile_menu() {
 $hook_suffix = add_options_page(__('Wiki Userprofile','codecocktail-wikiprofile'),__('Wiki Userprofile','codecocktail-wikiprofile'), 'manage_options', 'wiki-profile', 'wiki_profile_options' );
...
function wiki_profile_options() {
	...
	echo '
	  ...
	  <h2>'.__('Wiki Userprofile Settings','codecocktail-wikiprofile').'</h2>
	  <table class="form-table">
		<tbody>
		  <tr>
			<td width="30%" valign="top"><strong>'.__('Wikipedia UserName:','codecocktail-wikiprofile').'</strong></td>
			<td valign="top">
			<input type="text" name="codecocktail_wiki_username" value="'.get_option("codecocktail_wiki_username").'" size="60"/>
			</td>
		  </tr>
		  <tr>
			<td width="30%" valign="top"><strong>'.__('Parameters:','codecocktail-wikiprofile').'</strong></td>
			<td valign="top">
	...
	<strong>'.__("Example Shortcode Usage:","codecocktail-wikiprofile").'</strong>
	<ul>
		<li>[wikiuser]</li>
	...
	<strong>'.__("Feedback","codecocktail-wikiprofile").'</strong>
	 ...
	 <a href="mailto:gchokeen@gmail.com?subject=Wp Wiki Userprofile Feedback">'.__("Future request","codecocktail-wikiprofile").'</a>, 
	 <a href="mailto:gchokeen@gmail.com?subject=Wp Wiki Userprofile Suggestion">'.__("Suggestion","codecocktail-wikiprofile").'</a>,
	 <a href="mailto:gchokeen@gmail.com?subject=Wp Wiki Userprofile Bug Report">'.__("Bug Report","codecocktail-wikiprofile").'</a> 
	 or 
	 <a href="mailto:gchokeen@gmail.com?subject=Wp Wiki Userprofile Future request">'.__("Future request","codecocktail-wikiprofile").'</a> 
	 from you.</p>
	</div>
	</div>
...
function wiki_profile_admin_notices() {
	echo "<div id='notice' class='updated fade'><p>". __( 'Wiki Userprofile is not configured yet. Please configure it <a href="'.admin_url( 'options-general.php?page=wiki-profile').'">here</a> .','codecocktail-wikiprofile' )."</p></div>\n";
}
...
class Wiki_Profile_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Wiki Userprofile Widget', 'codecocktail-wikiprofile' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'New title', 'codecocktail-wikiprofile' );
		}
		?>
		<p>
